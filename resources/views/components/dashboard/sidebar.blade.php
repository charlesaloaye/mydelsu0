...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('cgpa.calculator') }}"><i class="fas fa-graduation-cap"></i> My CGPA</a></li>
        ...
        <li><a wire:click='logout' href="{{ route('auth.logout') }}"><i class="fas fa-sign-out"></i>Logout</a></li>
    </ul>
</div>