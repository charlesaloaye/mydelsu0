<div wire:poll.visible.30000ms> <!-- Update 3secs -->
    <header>
        ...
        <div class="header-actions">
            <div class="user-avatar" id="userInitials">{{ substr(Auth::user()->first_name, 0, 1) }}</div>
        </div>
    </header>
    ...
    <div class="setup-container">
        <div class="setup-card">
            ...
            <a href="{{ config('app.whatsapp') }}?text=I want to activate my account, my name is {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}"
