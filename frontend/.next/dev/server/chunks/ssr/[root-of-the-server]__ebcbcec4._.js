...
"[project]/app/dashboard/settings/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SettingsPage() {
    ...
    const [notificationPreferences, setNotificationPreferences] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        email_notifications: true,
        push_notifications: true,
        sms_notifications: false,
        marketing_emails: false
    });
    const [privacySettings, setPrivacySettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        profile_visibility: "public",
        show_email: false,
        show_phone: false,
        show_whatsapp: true
    });
    const [themeSettings, setThemeSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({
        theme: "light",
        auto_theme: true
    });
    ...
    const handlePasswordChange = async ()=>{
        ...
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updateProfile({
    ...
    const handleProfileUpdate = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updateProfile(profileData);
            if (response.success) {
    ...
    const handleNotificationPreferencesUpdate = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updateNotificationPreferences(notificationPreferences);
            if (response.success) {
    ...
    const handlePrivacySettingsUpdate = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updatePrivacySettings(privacySettings);
            if (response.success) {
    ...
    const handleThemeSettingsUpdate = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].updateThemeSettings(themeSettings);
            if (response.success) {
    ...
    const handleDeactivateAccount = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].deactivateAccount();
            if (response.success) {
    ...
    const handleDeleteAccount = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].deleteAccount();
            if (response.success) {
                showSuccess(response.message);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ebcbcec4._.js.map