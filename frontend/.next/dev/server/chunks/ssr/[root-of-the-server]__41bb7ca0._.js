...
"[project]/app/dashboard/events/[id]/page.jsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventPage() {
    ...
    const loadEvent = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/events/${id}`);
            if (response.success) {
    ...
    const handleContactSubmit = async (e)=>{
        ...
        try {
            setSubmitting(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/events/${id}/contact`, contactForm);
            if (response.success) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41bb7ca0._.js.map